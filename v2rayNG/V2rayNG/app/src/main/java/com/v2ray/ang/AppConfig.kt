...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/rakiyatraketa-arch/apex-vpn-android"
    const val APP_API_URL = "https://api.github.com/repos/rakiyatraketa-arch/apex-vpn-android/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$APP_URL"
    ...
    const val RAY_NG_CHANNEL_NAME = "Apex VPN"
